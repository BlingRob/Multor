...
Window::Window(std::array<std::function<void(void*)>, 5>* sigs, std::shared_ptr<Position_Controller> contr)
{
	...
	//Creating SDL window
	_pWindow = std::shared_ptr<SDL_Window>(SDL_CreateWindow("Vulkan test window", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 800, SDL_WINDOW_VULKAN | SDL_WINDOW_RESIZABLE),
